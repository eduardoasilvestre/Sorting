...
//http://chinmaylokesh.wordpress.com/2011/03/01/order-statistics-general-find-the-kth-smallest-element-from-an-unsorted-array-in-linear-time-specific-find-median-of-unsorted-array-in-linear-time/

//http://technocratme.blogspot.com.br/2012/05/median-of-medians-algorithm.html
//http://geekmeal.blogspot.com.br/2013/02/median-of-medians-algorithm.html
public class MedianOfMedians {
	 ...
	 * 
	 * System.out.println("-----------------------"); for( int q = 0 ; q < 50 ;
	 * q++ ) { l_list.add(new Integer(g_Generator.nextInt(1000))); }
	 * 
	 * printList(l_list);
	 * 
	 * System.out.println("Median: " + select(l_list, l_list.size()/2));
	 * 
	 * Collections.sort(l_list); printList(l_list);
	 * 
	 * System.out.println("-----------------------"); } }
	 */
